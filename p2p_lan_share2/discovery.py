...
def _compute_peer_id() -> str:
    ...
    cert_path, _ = crypto.ensure_cert()
...
# Backwards-compat alias (web_server imports this name historically).
_local_ip = local_ip


class PeerRegistry(QObject):
    """Owns Zeroconf, broadcasts self, and tracks discovered peers."""
